    	...
    	while (42) {
    	    ...
    	    if (strcmp(PLAY,"help") == 0){
                ...
                */
                ...
                cardDrawn = 1; 
                printf ("Passed your turn onto the next player!\n");
                break; //exit while loop #1
            } 
            ...
            // ==========================================================================================
                ...
                while ((x == 0 || v == 0) && cardPerTurn == 0){ 
                    ...
                    if (x == 1 && v == 1) {
                        ...
                        printf("||\n");
                        printf("You have played your card for the turn!\n");
                        cardPerTurn = 1;
                        //printf("HELLO????%d\n",cardPerTurn);
                    }
